...
public class PushDemoActivity extends CordovaPlugin {
	...
	public static CallbackContext messageCbContext;
	...
	public boolean execute(String action, JSONArray args,
		...
		Log.d(PLUGIN_NAME, callbackContext.toString());
		...
		if (action.equalsIgnoreCase(INIT_WORK)) {
			try {
				...
				String packageName = cordova.getActivity().getClass()
						.getPackage().getName();
				PackageManager pkgMgt = cordova.getActivity()
						.getPackageManager();
				Intent mainintent = pkgMgt
			...
			return true;
		} else if (action.equalsIgnoreCase("actionMessage")) {
			this.messageCbContext = callbackContext;
			return true;
